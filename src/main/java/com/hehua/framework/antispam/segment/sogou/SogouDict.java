...
public class SogouDict implements DictI {

    public static SogouDict instance = new SogouDict();
    ...
    /** 单例模式 */
    public static SogouDict getInstance() {
        return instance;
    }

    /** 初始化 */
    public void init() {
        InputStream istream = SogouDict.class.getResourceAsStream("resource/sogou.dic");
        ...
        try {
            while ((record = bin.readLine()) != null) {
                ...
                SogouDictExtraInfo info = new SogouDictExtraInfo(freqence, wordType);
