...
public class CompositeExtractText {
    ...
    public String getText(String src) {
        ...
        return CharNormalization.compositeTextConvert(src, true,true, true, true, false,true,true,false);
    }
    
    public String getChineseText(String src){
        if(src==null){
            return src;
        }
        return CharNormalization.compositeTextConvert(src, true, true, true, true, true, true, true, false);
    }
